...
int main()
{
    ...
    VAOs.push_back(createTriangle(-0.8, 0.8, -0.1, 0.3, -0.5, 0.7));
    VAOs.push_back(createTriangle(-0.6, 0.2, 0.6, 0.2, 0.0, 0.4));
    VAOs.push_back(createTriangle(0.4, 0.2, 0.2, 0.2, 0.6, 0.7));
    VAOs.push_back(createTriangle(-0.6, 0.0, -0.6, -0.6, -0.7, -0.6));
    VAOs.push_back(createTriangle(0.6, 0.6, 0.6, 0.0, 0.7, -0.7));
